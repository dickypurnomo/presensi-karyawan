...
<div class="container-fluid">
  <div class="row">
    ...
    $AmbilDataUser = "SELECT * FROM user";
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>
        <a href='edituser.php?id=" . $row['id'] . "' class='text-dark'><span data-feather='edit'></span></a>
        <a href='datauser.php?delete=" . $row['id'] . "' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?')\" class='text-dark'><span data-feather='trash-2'></span></a>
    </td>";    
        echo "</tr>";
    }
    ?>
